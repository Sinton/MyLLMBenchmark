...
use super::VisionSample;

pub(super) fn generate_content_body(prompt: &str, workload: &WorkloadConfig) -> serde_json::Value {
    serde_json::json!({
        "contents": [{
            "role": "user",
            "parts": [{"text": prompt}]
...
pub(super) fn vision_generate_content_body(
    sample: &VisionSample,
...
pub(super) fn usage_from_value(value: &serde_json::Value) -> Option<(i64, i64, i64)> {
